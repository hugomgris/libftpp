...
/**
 * @brief Base Widget class for creating UI components
 * 
...
public:
    ...
    Widget(const Widget& other) = delete; // Prevent copying due to unique ownership
...
/**
 * @brief Button widget with click functionality
 */
...
private:
    std::string _text;
    std::string _alignment; // "left", "center", "right"
...
/**
 * @brief Panel widget for grouping other widgets
 */
